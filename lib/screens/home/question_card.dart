...
import 'package:firebase_study_app/widgets/app_icon_text.dart';
            ...
            children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            text: Text('${model.questionCount} questions',style: detailText.copyWith(
                            ...
                            AppIconText(icon: Icon(Icons.timer,
                              color: Get.isDarkMode? Colors.white:
                              Theme.of(context).primaryColor,),
                              text: Text('${model.timeInMinutes()}',style: detailText.copyWith(
                                  color: Get.isDarkMode? Colors.white:Theme.of(context).primaryColor
                              ),),)
                          ],
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  horizontal: 20),
                  child: Icon(AppIcons.traphyOutline,),
                  decoration: BoxDecoration(
